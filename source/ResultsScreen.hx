...
class ResultsScreen extends FlxSubState
{
	...
	override function create()
	{
		...
		text = new FlxText(20, -55, 0, "Not Done Yet!");
		text.size = 34;
		...
		comboText = new FlxText(20, -75, 0,
			'IGN Review:\nSupers - ${sicks}\nThe Rocks - ${goods}\nGarbages - ${bads}\n\nMc Combos Breaks: ${(PlayState.isStoryMode ? PlayState.campaignMisses : PlayState.misses)}\nHighest amount of China Social credit earned: ${PlayState.highestCombo + 1}\nChina Social credit earned: ${PlayState.instance.songScore}\nAudience Score: ${HelperFunctions.truncateFloat(PlayState.instance.accuracy, 2)}%\n\n${Ratings.GenerateLetterRank(PlayState.instance.accuracy)}\nTomatometer: ${PlayState.songMultiplier}x\n\n${!PlayState.loadRep ? "\nF1 - Torture yourself again" : ""}
        ');
		comboText.size = 28;
		...
		contText = new FlxText(FlxG.width - 475, FlxG.height + 50, 0, 'Press ${KeyBinds.gamepad ? 'A' : 'ALT-F4'} to RUN AWAY AS FAST AS YOU CAN.');
		contText.size = 28;
